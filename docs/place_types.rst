...
该元素定义了该地点类型的颜色，决定了 *地点标题的颜色、地图格的底色等，还不清楚*。有关填入内容的具体情况请参见 :ref:`colours`。

backgroundColour
---------------------

该元素定义了该地点类型的背景颜色，决定了 *还不清楚*。与 `colour`_ 基本相似。
